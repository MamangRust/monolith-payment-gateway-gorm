...
const (
	...
	TransactionCommandService_AuthorizeTransaction_FullMethodName          = "/pb.transaction.TransactionCommandService/AuthorizeTransaction"
	TransactionCommandService_CaptureTransaction_FullMethodName            = "/pb.transaction.TransactionCommandService/CaptureTransaction"
	TransactionCommandService_VoidTransaction_FullMethodName               = "/pb.transaction.TransactionCommandService/VoidTransaction"
	TransactionCommandService_RefundTransaction_FullMethodName             = "/pb.transaction.TransactionCommandService/RefundTransaction"
)
...
type TransactionCommandServiceClient interface {
	...
	AuthorizeTransaction(ctx context.Context, in *CreateTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error)
	CaptureTransaction(ctx context.Context, in *CaptureTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error)
	VoidTransaction(ctx context.Context, in *VoidTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error)
	RefundTransaction(ctx context.Context, in *RefundTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error)
}
...
func (c *transactionCommandServiceClient) AuthorizeTransaction(ctx context.Context, in *CreateTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseTransaction)
	err := c.cc.Invoke(ctx, TransactionCommandService_AuthorizeTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionCommandServiceClient) CaptureTransaction(ctx context.Context, in *CaptureTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseTransaction)
	err := c.cc.Invoke(ctx, TransactionCommandService_CaptureTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionCommandServiceClient) VoidTransaction(ctx context.Context, in *VoidTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseTransaction)
	err := c.cc.Invoke(ctx, TransactionCommandService_VoidTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionCommandServiceClient) RefundTransaction(ctx context.Context, in *RefundTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseTransaction)
	err := c.cc.Invoke(ctx, TransactionCommandService_RefundTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransactionCommandServiceServer interface {
	...
	AuthorizeTransaction(context.Context, *CreateTransactionRequest) (*ApiResponseTransaction, error)
	CaptureTransaction(context.Context, *CaptureTransactionRequest) (*ApiResponseTransaction, error)
	VoidTransaction(context.Context, *VoidTransactionRequest) (*ApiResponseTransaction, error)
	RefundTransaction(context.Context, *RefundTransactionRequest) (*ApiResponseTransaction, error)
...
func (UnimplementedTransactionCommandServiceServer) AuthorizeTransaction(context.Context, *CreateTransactionRequest) (*ApiResponseTransaction, error) {
	return nil, status.Error(codes.Unimplemented, "method AuthorizeTransaction not implemented")
}
func (UnimplementedTransactionCommandServiceServer) CaptureTransaction(context.Context, *CaptureTransactionRequest) (*ApiResponseTransaction, error) {
	return nil, status.Error(codes.Unimplemented, "method CaptureTransaction not implemented")
}
func (UnimplementedTransactionCommandServiceServer) VoidTransaction(context.Context, *VoidTransactionRequest) (*ApiResponseTransaction, error) {
	return nil, status.Error(codes.Unimplemented, "method VoidTransaction not implemented")
}
func (UnimplementedTransactionCommandServiceServer) RefundTransaction(context.Context, *RefundTransactionRequest) (*ApiResponseTransaction, error) {
...
func _TransactionCommandService_AuthorizeTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionCommandServiceServer).AuthorizeTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionCommandService_AuthorizeTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionCommandServiceServer).AuthorizeTransaction(ctx, req.(*CreateTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TransactionCommandService_CaptureTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CaptureTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionCommandServiceServer).CaptureTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionCommandService_CaptureTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionCommandServiceServer).CaptureTransaction(ctx, req.(*CaptureTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TransactionCommandService_VoidTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VoidTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionCommandServiceServer).VoidTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionCommandService_VoidTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionCommandServiceServer).VoidTransaction(ctx, req.(*VoidTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TransactionCommandService_RefundTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RefundTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionCommandServiceServer).RefundTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionCommandService_RefundTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionCommandServiceServer).RefundTransaction(ctx, req.(*RefundTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TransactionCommandService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TransactionCommandService_AuthorizeTransaction_Handler,
		},
		{
			MethodName: "CaptureTransaction",
			Handler:    _TransactionCommandService_CaptureTransaction_Handler,
		},
		{
			MethodName: "VoidTransaction",
			Handler:    _TransactionCommandService_VoidTransaction_Handler,
		},
		{
			MethodName: "RefundTransaction",
			Handler:    _TransactionCommandService_RefundTransaction_Handler,
		},
	},
