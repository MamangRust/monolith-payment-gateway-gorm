...
const (
	...
	CardStatsTransactionService_FindDailyTransactionAmount_FullMethodName               = "/pb.card.stats.CardStatsTransactionService/FindDailyTransactionAmount"
	CardStatsTransactionService_FindDailyTransactionAmountByCardNumber_FullMethodName   = "/pb.card.stats.CardStatsTransactionService/FindDailyTransactionAmountByCardNumber"
)
...
type CardStatsTransactionServiceClient interface {
	...
	FindDailyTransactionAmount(ctx context.Context, in *card.FindYearAmount, opts ...grpc.CallOption) (*card.ApiResponseDailyAmount, error)
	FindDailyTransactionAmountByCardNumber(ctx context.Context, in *card.FindYearAmountCardNumber, opts ...grpc.CallOption) (*card.ApiResponseDailyAmount, error)
}
...
func (c *cardStatsTransactionServiceClient) FindDailyTransactionAmount(ctx context.Context, in *card.FindYearAmount, opts ...grpc.CallOption) (*card.ApiResponseDailyAmount, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(card.ApiResponseDailyAmount)
	err := c.cc.Invoke(ctx, CardStatsTransactionService_FindDailyTransactionAmount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cardStatsTransactionServiceClient) FindDailyTransactionAmountByCardNumber(ctx context.Context, in *card.FindYearAmountCardNumber, opts ...grpc.CallOption) (*card.ApiResponseDailyAmount, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(card.ApiResponseDailyAmount)
	err := c.cc.Invoke(ctx, CardStatsTransactionService_FindDailyTransactionAmountByCardNumber_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CardStatsTransactionServiceServer interface {
	...
	FindDailyTransactionAmount(context.Context, *card.FindYearAmount) (*card.ApiResponseDailyAmount, error)
	FindDailyTransactionAmountByCardNumber(context.Context, *card.FindYearAmountCardNumber) (*card.ApiResponseDailyAmount, error)
...
func (UnimplementedCardStatsTransactionServiceServer) FindDailyTransactionAmount(context.Context, *card.FindYearAmount) (*card.ApiResponseDailyAmount, error) {
	return nil, status.Error(codes.Unimplemented, "method FindDailyTransactionAmount not implemented")
}
func (UnimplementedCardStatsTransactionServiceServer) FindDailyTransactionAmountByCardNumber(context.Context, *card.FindYearAmountCardNumber) (*card.ApiResponseDailyAmount, error) {
	return nil, status.Error(codes.Unimplemented, "method FindDailyTransactionAmountByCardNumber not implemented")
}
...
func _CardStatsTransactionService_FindDailyTransactionAmount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(card.FindYearAmount)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardStatsTransactionServiceServer).FindDailyTransactionAmount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CardStatsTransactionService_FindDailyTransactionAmount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardStatsTransactionServiceServer).FindDailyTransactionAmount(ctx, req.(*card.FindYearAmount))
	}
	return interceptor(ctx, in, info, handler)
}

func _CardStatsTransactionService_FindDailyTransactionAmountByCardNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(card.FindYearAmountCardNumber)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardStatsTransactionServiceServer).FindDailyTransactionAmountByCardNumber(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CardStatsTransactionService_FindDailyTransactionAmountByCardNumber_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardStatsTransactionServiceServer).FindDailyTransactionAmountByCardNumber(ctx, req.(*card.FindYearAmountCardNumber))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CardStatsTransactionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindDailyTransactionAmount",
			Handler:    _CardStatsTransactionService_FindDailyTransactionAmount_Handler,
		},
		{
			MethodName: "FindDailyTransactionAmountByCardNumber",
			Handler:    _CardStatsTransactionService_FindDailyTransactionAmountByCardNumber_Handler,
		},
	},
