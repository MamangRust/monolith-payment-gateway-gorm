...
const (
	...
	CardStatsTopupService_FindDailyTopupAmount_FullMethodName               = "/pb.card.stats.CardStatsTopupService/FindDailyTopupAmount"
	CardStatsTopupService_FindDailyTopupAmountByCardNumber_FullMethodName   = "/pb.card.stats.CardStatsTopupService/FindDailyTopupAmountByCardNumber"
)
...
type CardStatsTopupServiceClient interface {
	...
	FindDailyTopupAmount(ctx context.Context, in *card.FindYearAmount, opts ...grpc.CallOption) (*card.ApiResponseDailyAmount, error)
	FindDailyTopupAmountByCardNumber(ctx context.Context, in *card.FindYearAmountCardNumber, opts ...grpc.CallOption) (*card.ApiResponseDailyAmount, error)
}
...
func (c *cardStatsTopupServiceClient) FindDailyTopupAmount(ctx context.Context, in *card.FindYearAmount, opts ...grpc.CallOption) (*card.ApiResponseDailyAmount, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(card.ApiResponseDailyAmount)
	err := c.cc.Invoke(ctx, CardStatsTopupService_FindDailyTopupAmount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cardStatsTopupServiceClient) FindDailyTopupAmountByCardNumber(ctx context.Context, in *card.FindYearAmountCardNumber, opts ...grpc.CallOption) (*card.ApiResponseDailyAmount, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(card.ApiResponseDailyAmount)
	err := c.cc.Invoke(ctx, CardStatsTopupService_FindDailyTopupAmountByCardNumber_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CardStatsTopupServiceServer interface {
	...
	FindDailyTopupAmount(context.Context, *card.FindYearAmount) (*card.ApiResponseDailyAmount, error)
	FindDailyTopupAmountByCardNumber(context.Context, *card.FindYearAmountCardNumber) (*card.ApiResponseDailyAmount, error)
...
func (UnimplementedCardStatsTopupServiceServer) FindDailyTopupAmount(context.Context, *card.FindYearAmount) (*card.ApiResponseDailyAmount, error) {
	return nil, status.Error(codes.Unimplemented, "method FindDailyTopupAmount not implemented")
}
func (UnimplementedCardStatsTopupServiceServer) FindDailyTopupAmountByCardNumber(context.Context, *card.FindYearAmountCardNumber) (*card.ApiResponseDailyAmount, error) {
	return nil, status.Error(codes.Unimplemented, "method FindDailyTopupAmountByCardNumber not implemented")
}
...
func _CardStatsTopupService_FindDailyTopupAmount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(card.FindYearAmount)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardStatsTopupServiceServer).FindDailyTopupAmount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CardStatsTopupService_FindDailyTopupAmount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardStatsTopupServiceServer).FindDailyTopupAmount(ctx, req.(*card.FindYearAmount))
	}
	return interceptor(ctx, in, info, handler)
}

func _CardStatsTopupService_FindDailyTopupAmountByCardNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(card.FindYearAmountCardNumber)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardStatsTopupServiceServer).FindDailyTopupAmountByCardNumber(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CardStatsTopupService_FindDailyTopupAmountByCardNumber_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardStatsTopupServiceServer).FindDailyTopupAmountByCardNumber(ctx, req.(*card.FindYearAmountCardNumber))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CardStatsTopupService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindDailyTopupAmount",
			Handler:    _CardStatsTopupService_FindDailyTopupAmount_Handler,
		},
		{
			MethodName: "FindDailyTopupAmountByCardNumber",
			Handler:    _CardStatsTopupService_FindDailyTopupAmountByCardNumber_Handler,
		},
	},
