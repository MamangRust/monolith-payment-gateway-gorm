...
func (UnimplementedCardQueryServiceServer) FindAllCard(context.Context, *FindAllCardRequest) (*ApiResponsePaginationCard, error) {
	return nil, status.Error(codes.Unimplemented, "method FindAllCard not implemented")
}
func (UnimplementedCardQueryServiceServer) FindByIdCard(context.Context, *FindByIdCardRequest) (*ApiResponseCard, error) {
	return nil, status.Error(codes.Unimplemented, "method FindByIdCard not implemented")
}
func (UnimplementedCardQueryServiceServer) FindByUserIdCard(context.Context, *FindByUserIdCardRequest) (*ApiResponseCard, error) {
	return nil, status.Error(codes.Unimplemented, "method FindByUserIdCard not implemented")
}
func (UnimplementedCardQueryServiceServer) FindByActiveCard(context.Context, *FindAllCardRequest) (*ApiResponsePaginationCardDeleteAt, error) {
	return nil, status.Error(codes.Unimplemented, "method FindByActiveCard not implemented")
}
func (UnimplementedCardQueryServiceServer) FindByTrashedCard(context.Context, *FindAllCardRequest) (*ApiResponsePaginationCardDeleteAt, error) {
	return nil, status.Error(codes.Unimplemented, "method FindByTrashedCard not implemented")
}
...
func (UnimplementedCardQueryServiceServer) FindUserCardByCardNumber(context.Context, *FindByCardNumberRequest) (*CardWithEmailResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FindUserCardByCardNumber not implemented")
}
...
func RegisterCardQueryServiceServer(s grpc.ServiceRegistrar, srv CardQueryServiceServer) {
	// If the following call panics, it indicates UnimplementedCardQueryServiceServer was
