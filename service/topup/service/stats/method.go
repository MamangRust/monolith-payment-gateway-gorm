...
import (
	...
	mencache "github.com/MamangRust/monolith-payment-gateway-topup/redis/stats"
...
func (s *topupStatsMethodService) FindMonthlyTopupMethods(ctx context.Context, year int) ([]*models.TopupMonthlyMethodRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TopupMonthlyMethodRow](
			s.logger,
...
func (s *topupStatsMethodService) FindYearlyTopupMethods(ctx context.Context, year int) ([]*models.TopupYearlyMethodRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TopupYearlyMethodRow](
			s.logger,
