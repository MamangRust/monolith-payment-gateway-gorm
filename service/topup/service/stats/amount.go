...
func (s *topupStatsAmountService) FindMonthlyTopupAmounts(ctx context.Context, year int) ([]*models.TopupMonthlyAmountRow, error) {
...
func (s *topupStatsAmountService) FindYearlyTopupAmounts(ctx context.Context, year int) ([]*models.TopupYearlyAmountRow, error) {
