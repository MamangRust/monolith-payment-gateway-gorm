...
import (
	...
	cache "github.com/MamangRust/monolith-payment-gateway-topup/redis/stats"
	repository "github.com/MamangRust/monolith-payment-gateway-topup/repository/stats"
...
func (s *topupStatsStatusService) FindMonthTopupStatusSuccess(ctx context.Context, req *requests.MonthTopupStatus) ([]*models.TopupMonthlyStatusRow, error) {
...
func (s *topupStatsStatusService) FindYearlyTopupStatusSuccess(ctx context.Context, year int) ([]*models.TopupYearlyStatusRow, error) {
...
func (s *topupStatsStatusService) FindMonthTopupStatusFailed(ctx context.Context, req *requests.MonthTopupStatus) ([]*models.TopupMonthlyStatusRow, error) {
...
func (s *topupStatsStatusService) FindYearlyTopupStatusFailed(ctx context.Context, year int) ([]*models.TopupYearlyStatusRow, error) {
