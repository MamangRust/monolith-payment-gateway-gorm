...
func (s *topupQueryService) FindAll(ctx context.Context, req *requests.FindAllTopups) ([]*models.TopupListRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.TopupListRow](
			s.logger,
...
func (s *topupQueryService) FindAllByCardNumber(ctx context.Context, req *requests.FindAllTopupsByCardNumber) ([]*models.TopupListRow, *int, error) {
...
func (s *topupQueryService) FindById(ctx context.Context, topupID int) (*models.TopupAllFieldsRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.TopupAllFieldsRow](
			s.logger,
...
func (s *topupQueryService) FindByActive(ctx context.Context, req *requests.FindAllTopups) ([]*models.TopupListRow, *int, error) {
...
func (s *topupQueryService) FindByTrashed(ctx context.Context, req *requests.FindAllTopups) ([]*models.TopupListWithDeletedRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.TopupListWithDeletedRow](
			s.logger,
