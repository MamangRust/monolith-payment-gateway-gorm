...
func (s *withdrawQueryService) FindAll(ctx context.Context, req *requests.FindAllWithdraws) ([]*models.WithdrawListRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.WithdrawListRow](
			s.logger,
...
func (s *withdrawQueryService) FindAllByCardNumber(ctx context.Context, req *requests.FindAllWithdrawCardNumber) ([]*models.WithdrawByCardNumberRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.WithdrawByCardNumberRow](
			s.logger,
...
func (s *withdrawQueryService) FindByActive(ctx context.Context, req *requests.FindAllWithdraws) ([]*models.WithdrawListRow, *int, error) {
...
func (s *withdrawQueryService) FindByTrashed(ctx context.Context, req *requests.FindAllWithdraws) ([]*models.WithdrawListWithDeletedRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.WithdrawListWithDeletedRow](
			s.logger,
...
func (s *withdrawQueryService) FindById(ctx context.Context, withdrawID int) (*models.WithdrawAllFieldsRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.WithdrawAllFieldsRow](
			s.logger,
