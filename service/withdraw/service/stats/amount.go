...
func (s *withdrawStatsAmountService) FindMonthlyWithdraws(ctx context.Context, year int) ([]*models.WithdrawMonthlyAmountRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.WithdrawMonthlyAmountRow](
			s.logger,
...
func (s *withdrawStatsAmountService) FindYearlyWithdraws(ctx context.Context, year int) ([]*models.WithdrawYearlyAmountRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.WithdrawYearlyAmountRow](
			s.logger,
