...
func (s *withdrawStatsStatusService) FindMonthWithdrawStatusSuccess(ctx context.Context, req *requests.MonthStatusWithdraw) ([]*models.WithdrawMonthlyStatusSuccessRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.WithdrawMonthlyStatusSuccessRow](
			s.logger,
...
func (s *withdrawStatsStatusService) FindYearlyWithdrawStatusSuccess(ctx context.Context, year int) ([]*models.WithdrawYearlyStatusSuccessRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.WithdrawYearlyStatusSuccessRow](
			s.logger,
...
func (s *withdrawStatsStatusService) FindMonthWithdrawStatusFailed(ctx context.Context, req *requests.MonthStatusWithdraw) ([]*models.WithdrawMonthlyStatusFailedRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.WithdrawMonthlyStatusFailedRow](
			s.logger,
...
func (s *withdrawStatsStatusService) FindYearlyWithdrawStatusFailed(ctx context.Context, year int) ([]*models.WithdrawYearlyStatusFailedRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.WithdrawYearlyStatusFailedRow](
			s.logger,
