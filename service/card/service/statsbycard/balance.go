...
func (s *cardStatsBalanceByCardService) FindMonthlyBalancesByCardNumber(ctx context.Context, req *requests.MonthYearCardNumberCard) ([]*models.MonthlyBalanceRow, error) {
	...
	if err != nil {
		status = "error"
		return sharederrorhandler.HandleError[[]*models.MonthlyBalanceRow](
			s.logger,
...
func (s *cardStatsBalanceByCardService) FindYearlyBalanceByCardNumber(ctx context.Context, req *requests.MonthYearCardNumberCard) ([]*models.YearlyBalanceRow, error) {
	...
	if err != nil {
		status = "error"
		return sharederrorhandler.HandleError[[]*models.YearlyBalanceRow](
			s.logger,
