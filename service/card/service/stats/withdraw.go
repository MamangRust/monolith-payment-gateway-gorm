...
func (s *cardStatsWithdrawService) FindMonthlyWithdrawAmount(ctx context.Context, year int) ([]*models.MonthlyWithdrawRow, error) {
...
func (s *cardStatsWithdrawService) FindYearlyWithdrawAmount(ctx context.Context, year int) ([]*models.YearlyWithdrawRow, error) {
