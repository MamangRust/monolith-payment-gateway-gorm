...
func (s *cardStatsBalanceService) FindMonthlyBalance(ctx context.Context, year int) ([]*models.MonthlyBalanceRow, error) {
...
func (s *cardStatsBalanceService) FindYearlyBalance(ctx context.Context, year int) ([]*models.YearlyBalanceRow, error) {
