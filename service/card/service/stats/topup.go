...
func (s *cardStatsTopupService) FindMonthlyTopupAmount(ctx context.Context, year int) ([]*models.MonthlyTopupRow, error) {
...
func (s *cardStatsTopupService) FindYearlyTopupAmount(ctx context.Context, year int) ([]*models.YearlyTopupRow, error) {
