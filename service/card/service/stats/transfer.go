...
func (s *cardStatsTransferService) FindMonthlyTransferAmountSender(ctx context.Context, year int) ([]*models.MonthlyTransferSentRow, error) {
...
func (s *cardStatsTransferService) FindYearlyTransferAmountSender(ctx context.Context, year int) ([]*models.YearlyTransferSentRow, error) {
...
func (s *cardStatsTransferService) FindMonthlyTransferAmountReceiver(ctx context.Context, year int) ([]*models.MonthlyTransferReceivedRow, error) {
...
func (s *cardStatsTransferService) FindYearlyTransferAmountReceiver(ctx context.Context, year int) ([]*models.YearlyTransferReceivedRow, error) {
