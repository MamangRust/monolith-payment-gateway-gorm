...
func (s *transferQueryService) FindAll(ctx context.Context, req *requests.FindAllTransfers) ([]*models.TransferListRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.TransferListRow](
			s.logger,
...
func (s *transferQueryService) FindById(ctx context.Context, transferId int) (*models.TransferAllFieldsRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.TransferAllFieldsRow](
			s.logger,
...
func (s *transferQueryService) FindByActive(ctx context.Context, req *requests.FindAllTransfers) ([]*models.TransferListRow, *int, error) {
...
func (s *transferQueryService) FindByTrashed(ctx context.Context, req *requests.FindAllTransfers) ([]*models.TransferListWithDeletedRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.TransferListWithDeletedRow](
			s.logger,
...
func (s *transferQueryService) FindTransferByTransferFrom(ctx context.Context, transfer_from string) ([]*models.TransferBySourceCardRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TransferBySourceCardRow](
			s.logger,
			transfer_errors.ErrTransferNotFound,
			method,
			span,
...
func (s *transferQueryService) FindTransferByTransferTo(ctx context.Context, transfer_to string) ([]*models.TransferByDestinationCardRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TransferByDestinationCardRow](
			s.logger,
			transfer_errors.ErrTransferNotFound,
			method,
			span,
