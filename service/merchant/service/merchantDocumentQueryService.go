...
func (s *merchantDocumentQueryService) FindAll(ctx context.Context, req *requests.FindAllMerchantDocuments) ([]*models.MerchantDocumentListRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.MerchantDocumentListRow](s.logger, err, method, span, zap.String("search", search))
	}
...
func (s *merchantDocumentQueryService) FindById(ctx context.Context, documentID int) (*models.MerchantDocumentAllFieldsRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.MerchantDocumentAllFieldsRow](s.logger, err, method, span, zap.Int("merchantDocument.id", documentID))
	}
...
func (s *merchantDocumentQueryService) FindByActive(ctx context.Context, req *requests.FindAllMerchantDocuments) ([]*models.MerchantDocumentListWithDeletedRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.MerchantDocumentListWithDeletedRow](s.logger, err, method, span, zap.String("search", search))
	}
...
func (s *merchantDocumentQueryService) FindByTrashed(ctx context.Context, req *requests.FindAllMerchantDocuments) ([]*models.MerchantDocumentListWithDeletedRow, *int, error) {
