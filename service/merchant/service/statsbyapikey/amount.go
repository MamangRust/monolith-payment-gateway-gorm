...
func (s *merchantStatsAmountByApiKeyService) FindMonthlyAmountByApikey(ctx context.Context, req *requests.MonthYearAmountApiKey) ([]*models.MerchantMonthlyAmountRow, error) {
	...
	logSuccess("Successfully found monthly amount by API key (from DB)", zap.String("api_key", observability.MaskIdentifier(req.Apikey)), zap.Int("year", req.Year))
	return dbRows, nil
}

func (s *merchantStatsAmountByApiKeyService) FindYearlyAmountByApikey(ctx context.Context, req *requests.MonthYearAmountApiKey) ([]*models.MerchantYearlyAmountRow, error) {
	...
	logSuccess("Successfully found yearly amount by API key (from DB)", zap.String("api_key", observability.MaskIdentifier(req.Apikey)), zap.Int("year", req.Year))
	return dbRows, nil
}
