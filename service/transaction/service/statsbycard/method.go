...
func (s *transactionStatsByCardMethodService) FindMonthlyPaymentMethodsByCardNumber(ctx context.Context, req *requests.MonthYearPaymentMethod) ([]*models.TransactionMonthlyPaymentMethodByCardRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TransactionMonthlyPaymentMethodByCardRow](
			s.logger,
...
func (s *transactionStatsByCardMethodService) FindYearlyPaymentMethodsByCardNumber(ctx context.Context, req *requests.MonthYearPaymentMethod) ([]*models.TransactionYearlyPaymentMethodByCardRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TransactionYearlyPaymentMethodByCardRow](
			s.logger,
