...
func (s *transactionQueryService) FindAll(ctx context.Context, req *requests.FindAllTransactions) ([]*models.TransactionListRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.TransactionListRow](
			s.logger,
...
func (s *transactionQueryService) FindAllByCardNumber(ctx context.Context, req *requests.FindAllTransactionCardNumber) ([]*models.TransactionListRow, *int, error) {
...
func (s *transactionQueryService) FindById(ctx context.Context, transactionID int) (*models.TransactionAllFieldsRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.TransactionAllFieldsRow](
			s.logger,
...
func (s *transactionQueryService) FindByActive(ctx context.Context, req *requests.FindAllTransactions) ([]*models.TransactionListRow, *int, error) {
...
func (s *transactionQueryService) FindByTrashed(ctx context.Context, req *requests.FindAllTransactions) ([]*models.TransactionListWithDeletedRow, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.TransactionListWithDeletedRow](
			s.logger,
...
func (s *transactionQueryService) FindTransactionByMerchantId(ctx context.Context, merchant_id int) ([]*models.TransactionListRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TransactionListRow](
			s.logger,
