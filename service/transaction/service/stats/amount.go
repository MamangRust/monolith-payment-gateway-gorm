...
func (s *transactionStatsAmountService) FindMonthlyAmounts(ctx context.Context, year int) ([]*models.TransactionMonthlyAmountRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TransactionMonthlyAmountRow](
			s.logger,
...
func (s *transactionStatsAmountService) FindYearlyAmounts(ctx context.Context, year int) ([]*models.TransactionYearlyAmountRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TransactionYearlyAmountRow](
			s.logger,
