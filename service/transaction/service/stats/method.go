...
func (s *transactionStatsMethodService) FindMonthlyPaymentMethods(ctx context.Context, year int) ([]*models.TransactionMonthlyPaymentMethodRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TransactionMonthlyPaymentMethodRow](
			s.logger,
...
func (s *transactionStatsMethodService) FindYearlyPaymentMethods(ctx context.Context, year int) ([]*models.TransactionYearlyPaymentMethodRow, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[[]*models.TransactionYearlyPaymentMethodRow](
			s.logger,
