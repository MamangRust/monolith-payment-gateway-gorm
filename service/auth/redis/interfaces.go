...
type IdentityCache interface {
	...
	SetCachedUserInfo(ctx context.Context, user *models.UserByIDRow, expiration time.Duration)

	GetCachedUserInfo(ctx context.Context, userId string) (*models.UserByIDRow, bool)
