...
const updateSaldoBalanceDelta = `-- name: UpdateSaldoBalanceDelta :one
UPDATE saldos
SET
...
type UpdateSaldoBalanceDeltaParams struct {
	CardNumber   string `json:"card_number"`
	TotalBalance int32  `json:"total_balance"`
}
...
func (q *Queries) UpdateSaldoBalanceDelta(ctx context.Context, arg UpdateSaldoBalanceDeltaParams) (*UpdateSaldoBalanceDeltaRow, error) {
	row := q.db.QueryRow(ctx, updateSaldoBalanceDelta, arg.CardNumber, arg.TotalBalance)
	var i UpdateSaldoBalanceDeltaRow
	err := row.Scan(
		&i.SaldoID,
		&i.CardNumber,
		&i.TotalBalance,
