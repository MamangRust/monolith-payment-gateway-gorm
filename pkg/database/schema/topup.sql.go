...
const createTopupAtomic = `-- name: CreateTopupAtomic :one
...
type CreateTopupAtomicParams struct {
	CardNumber     string `json:"card_number"`
	TopupAmount    int32  `json:"topup_amount"`
	TopupMethod    string `json:"topup_method"`
...
type CreateTopupAtomicRow struct {
	TopupID     int32            `json:"topup_id"`
	TopupNo     pgtype.UUID      `json:"topup_no"`
	CardNumber  string           `json:"card_number"`
	TopupAmount int32            `json:"topup_amount"`
...
func (q *Queries) CreateTopupAtomic(ctx context.Context, arg CreateTopupAtomicParams) (*CreateTopupAtomicRow, error) {
	row := q.db.QueryRow(ctx, createTopupAtomic,
		arg.CardNumber,
		arg.TopupAmount,
		arg.TopupMethod,
		arg.IdempotencyKey,
	)
	var i CreateTopupAtomicRow
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
		&i.CardNumber,
...
const getTopupByIdempotencyKey = `-- name: GetTopupByIdempotencyKey :one
SELECT
    topup_id,
    topup_no,
    card_number,
...
type GetTopupByIdempotencyKeyRow struct {
	TopupID     int32            `json:"topup_id"`
	TopupNo     pgtype.UUID      `json:"topup_no"`
	CardNumber  string           `json:"card_number"`
	TopupAmount int32            `json:"topup_amount"`
...
func (q *Queries) GetTopupByIdempotencyKey(ctx context.Context, idempotencyKey string) (*GetTopupByIdempotencyKeyRow, error) {
	row := q.db.QueryRow(ctx, getTopupByIdempotencyKey, idempotencyKey)
	var i GetTopupByIdempotencyKeyRow
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
		&i.CardNumber,
...
SELECT topup_id, topup_no, card_number, topup_amount, topup_method, topup_time, status, created_at, updated_at, deleted_at, idempotency_key
FROM topups
WHERE
    topup_id = $1
...
func (q *Queries) RestoreTopup(ctx context.Context, topupID int32) (*RestoreTopupRow, error) {
	row := q.db.QueryRow(ctx, restoreTopup, topupID)
	var i RestoreTopupRow
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
		&i.CardNumber,
...
func (q *Queries) TrashTopup(ctx context.Context, topupID int32) (*TrashTopupRow, error) {
...
const updateTopupAtomic = `-- name: UpdateTopupAtomic :one
...
type UpdateTopupAtomicParams struct {
	TopupID     int32  `json:"topup_id"`
	TopupAmount int32  `json:"topup_amount"`
	CardNumber  string `json:"card_number"`
	TopupMethod string `json:"topup_method"`
...
type UpdateTopupAtomicRow struct {
	TopupID     int32            `json:"topup_id"`
	TopupNo     pgtype.UUID      `json:"topup_no"`
	CardNumber  string           `json:"card_number"`
	TopupAmount int32            `json:"topup_amount"`
...
func (q *Queries) UpdateTopupAtomic(ctx context.Context, arg UpdateTopupAtomicParams) (*UpdateTopupAtomicRow, error) {
	row := q.db.QueryRow(ctx, updateTopupAtomic,
		arg.TopupID,
		arg.TopupAmount,
		arg.CardNumber,
		arg.TopupMethod,
	)
	var i UpdateTopupAtomicRow
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
		&i.CardNumber,
