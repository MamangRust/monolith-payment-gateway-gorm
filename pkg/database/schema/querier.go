...
type Querier interface {
	...
	AddRewardPoints(ctx context.Context, arg AddRewardPointsParams) (*AddRewardPointsRow, error)
	...
	AuthorizeTransactionAtomic(ctx context.Context, arg AuthorizeTransactionAtomicParams) (*AuthorizeTransactionAtomicRow, error)
	...
	CaptureTransactionAtomic(ctx context.Context, arg CaptureTransactionAtomicParams) (*CaptureTransactionAtomicRow, error)
	// ClaimOutboxEvents: Claims eligible outbox events for publishing.
	ClaimOutboxEvents(ctx context.Context, limit int32) ([]*ClaimOutboxEventsRow, error)
	// ClaimOutboxEventsByTopics: Claims eligible outbox events for selected topics.
	ClaimOutboxEventsByTopics(ctx context.Context, arg ClaimOutboxEventsByTopicsParams) ([]*ClaimOutboxEventsByTopicsRow, error)
	...
	CreateTopupAtomic(ctx context.Context, arg CreateTopupAtomicParams) (*CreateTopupAtomicRow, error)
	...
	CreateTransactionAtomic(ctx context.Context, arg CreateTransactionAtomicParams) (*CreateTransactionAtomicRow, error)
	...
	//   - Returns no row for a rejected operation; no balance is changed in that case.
	CreateTransferAtomic(ctx context.Context, arg CreateTransferAtomicParams) (*CreateTransferAtomicRow, error)
	...
	CreateWithdrawAtomic(ctx context.Context, arg CreateWithdrawAtomicParams) (*CreateWithdrawAtomicRow, error)
	...
	GetBillingCycleByID(ctx context.Context, billingID int32) (*BillingCycle, error)
	// GetBillingCycleByIDForUpdate: Retrieves and locks one billing cycle for an atomic payment transition.
	GetBillingCycleByIDForUpdate(ctx context.Context, billingID int32) (*BillingCycle, error)
	...
	GetCardByCardNumberWithStatus(ctx context.Context, cardNumber string) (*GetCardByCardNumberWithStatusRow, error)
	...
	GetCardPaymentByReferenceID(ctx context.Context, referenceID string) (*CardPayment, error)
	...
	GetDailyTopupAmount(ctx context.Context) (int64, error)
	...
	//   - Excludes soft-deleted records
	GetDailyTopupAmountByCardNumber(ctx context.Context, cardNumber string) (int64, error)
	...
	//   - Excludes soft-deleted records
	GetDailyTransactionAmount(ctx context.Context) (int64, error)
	...
	//   - Excludes soft-deleted records
	GetDailyTransactionAmountByCardNumber(ctx context.Context, cardNumber string) (int64, error)
	...
	//   - Excludes soft-deleted records
	GetDailyTransferAmountByReceiver(ctx context.Context) (int64, error)
	...
	//   - Excludes soft-deleted records
	GetDailyTransferAmountByReceiverCardNumber(ctx context.Context, transferTo string) (int64, error)
	...
	//   - Excludes soft-deleted records
	GetDailyTransferAmountBySender(ctx context.Context) (int64, error)
	...
	//   - Excludes soft-deleted records
	GetDailyTransferAmountBySenderCardNumber(ctx context.Context, transferFrom string) (int64, error)
	...
	//   - Excludes soft-deleted records
	GetDailyWithdrawAmount(ctx context.Context) (int64, error)
	...
	//   - Excludes soft-deleted records
	GetDailyWithdrawAmountByCardNumber(ctx context.Context, cardNumber string) (int64, error)
	...
	GetTopupByIdempotencyKey(ctx context.Context, idempotencyKey string) (*GetTopupByIdempotencyKeyRow, error)
	...
	GetTransactionByIDWithFraudScore(ctx context.Context, transactionID int32) (*GetTransactionByIDWithFraudScoreRow, error)
	...
	GetTransactionByIdempotencyKey(ctx context.Context, idempotencyKey string) (*GetTransactionByIdempotencyKeyRow, error)
	...
	//   - Excludes soft-deleted records
	GetTransactionVelocity(ctx context.Context, arg GetTransactionVelocityParams) (int32, error)
	...
	GetTransferByIdempotencyKey(ctx context.Context, idempotencyKey string) (*GetTransferByIdempotencyKeyRow, error)
	...
	//   - Used by the repository to return the original record instead of
	//     double-debiting when a request is retried.
	GetWithdrawByIdempotencyKey(ctx context.Context, idempotencyKey string) (*GetWithdrawByIdempotencyKeyRow, error)
	...
	InsertAuthTransaction(ctx context.Context, arg InsertAuthTransactionParams) (*InsertAuthTransactionRow, error)
	...
	InsertCardEventLog(ctx context.Context, arg InsertCardEventLogParams) (*CardEventLog, error)
	// =============================================================================
	...
	InsertCardPayment(ctx context.Context, arg InsertCardPaymentParams) (*InsertCardPaymentRow, error)
	// =============================================================================
	...
	ProcessBillingCycles(ctx context.Context, dollar_1 interface{}) ([]*ProcessBillingCyclesRow, error)
	...
	RefundTransactionAtomic(ctx context.Context, arg RefundTransactionAtomicParams) (*RefundTransactionAtomicRow, error)
	...
	RestoreMerchant(ctx context.Context, merchantID int32) (*RestoreMerchantRow, error)
	RestoreMerchantDocument(ctx context.Context, documentID int32) (*RestoreMerchantDocumentRow, error)
	...
	RestoreTopup(ctx context.Context, topupID int32) (*RestoreTopupRow, error)
	...
	RestoreTransaction(ctx context.Context, transactionID int32) (*RestoreTransactionRow, error)
	...
	RestoreTransfer(ctx context.Context, transferID int32) (*RestoreTransferRow, error)
	...
	//   - Used for data recovery purposes
	RestoreWithdraw(ctx context.Context, withdrawID int32) (*RestoreWithdrawRow, error)
	...
	TrashMerchant(ctx context.Context, merchantID int32) (*TrashMerchantRow, error)
	TrashMerchantDocument(ctx context.Context, documentID int32) (*TrashMerchantDocumentRow, error)
	...
	TrashTopup(ctx context.Context, topupID int32) (*TrashTopupRow, error)
	...
	//   - Only affects currently active records
	TrashTransaction(ctx context.Context, transactionID int32) (*TrashTransactionRow, error)
	...
	TrashTransfer(ctx context.Context, transferID int32) (*TrashTransferRow, error)
	...
	TrashWithdraw(ctx context.Context, withdrawID int32) (*TrashWithdrawRow, error)
	...
	//   - Only updates active (non-deleted) cards
	UpdateOutstandingBalance(ctx context.Context, arg UpdateOutstandingBalanceParams) (*UpdateOutstandingBalanceRow, error)
	...
	UpdateSaldoBalanceDelta(ctx context.Context, arg UpdateSaldoBalanceDeltaParams) (*UpdateSaldoBalanceDeltaRow, error)
	...
	UpdateTopupAtomic(ctx context.Context, arg UpdateTopupAtomicParams) (*UpdateTopupAtomicRow, error)
	...
	UpdateTransactionAtomic(ctx context.Context, arg UpdateTransactionAtomicParams) (*UpdateTransactionAtomicRow, error)
	...
	UpdateTransactionFraudScore(ctx context.Context, arg UpdateTransactionFraudScoreParams) (*UpdateTransactionFraudScoreRow, error)
	...
	UpdateTransactionStatusDirect(ctx context.Context, arg UpdateTransactionStatusDirectParams) (*UpdateTransactionStatusDirectRow, error)
	...
	UpdateTransferAtomic(ctx context.Context, arg UpdateTransferAtomicParams) (*UpdateTransferAtomicRow, error)
	...
	UpdateTransferSettlementDelta(ctx context.Context, arg UpdateTransferSettlementDeltaParams) (int32, error)
	...
	UpdateWithdrawAtomic(ctx context.Context, arg UpdateWithdrawAtomicParams) (*UpdateWithdrawAtomicRow, error)
	...
	VoidTransactionAtomic(ctx context.Context, transactionID int32) (*VoidTransactionAtomicRow, error)
}
